...
#     print(my_report.data_return())


class Report:
    def __init__(self, address: str, api: str) -> None:
        self.api = api.strip()
        self.address = address.strip()
        self.pin_point = set_geolocation(address)
        self.area_points = set_geolocation_area(self.pin_point[0], self.pin_point[1])
    ...
    def demogra_data(self) -> dict:
        self.geo_info = get_demographic_information(
            self.pin_point[0], self.pin_point[1], self.api
        )
    ...
    def average_sectore_score(self) -> float:
        self.score_data = get_scores_information(self.pin_point[0], self.pin_point[1], self.api)
        values_sum = []
    ...
    def data_return(self) -> list:
        ...
        self.demogra_data()
        self.__str__()
        return [self.final_price_listing, self.final_score_listing, self.geo_data]
